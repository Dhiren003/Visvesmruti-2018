var Austro=function()
{var austronaut=null;var _Austro=this;this.STOPPED=true;this.canvas=$('#canvasAustro');this.NAME='#canvasAustro';this.stage=new PIXI.Stage(0x000000);this.renderer=PIXI.autoDetectRenderer(this.canvas.width(),this.canvas.height(),this.canvas.get(0),true,true);var mission={};mission.x={};mission.x.min=25;mission.x.max=350;mission.y={};mission.y.min=250;mission.y.max=350;mission.scale={};mission.scale.min=0.6;mission.scale.max=1.2;mission.rotation={};mission.rotation.min=-0.9;mission.rotation.max=0.3;mission.phase=1;this.init=function(){astronaut=new PIXI.Sprite(PIXI.Texture.fromImage("img/austronaut.png"));astronaut.position.x=mission.x.min;astronaut.position.y=mission.y.min;astronaut.scale.x=mission.scale.min;astronaut.scale.y=mission.scale.min;astronaut.rotation=mission.rotation.min;astronaut.pivot.set(50,50);_Austro.stage.addChild(astronaut)
_Austro.animate();}
